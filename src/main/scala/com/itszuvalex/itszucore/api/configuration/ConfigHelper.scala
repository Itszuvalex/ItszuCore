...
object ConfigHelper {
        ...
        if (canno != null) {
          ...
          if (loader != null) {
            try {
              ...
              case e: Exception =>
                ItszuCore.logger.log(Level.WARN, "Error loading @Configurable field " + field.getName + " in class " + clazz.getName + ".")
                e.printStackTrace()
            }
          }
        }
  ...
  private def registerConfigLoaders() {
    loaderMap.put(classOf[Int], new ConfigHelper.FieldLoader[Integer] {
    ...
    loaderMap.put(classOf[Array[Int]], new ConfigHelper.FieldLoader[Array[Int]] {
      def load(field: Field, section: String, anno: Configurable, obj: AnyRef, config: Configuration) {
    ...
    loaderMap.put(classOf[Array[String]], new ConfigHelper.FieldLoader[Array[String]] {
      def load(field: Field, section: String, anno: Configurable, obj: AnyRef, config: Configuration) {
    ...
    loaderMap.put(classOf[Boolean], new ConfigHelper.FieldLoader[Boolean] {
      def load(field: Field, section: String, anno: Configurable, obj: AnyRef, config: Configuration) {
    ...
    loaderMap.put(classOf[Array[Boolean]], new ConfigHelper.FieldLoader[Array[Boolean]] {
      def load(field: Field, section: String, anno: Configurable, obj: AnyRef, config: Configuration) {
    ...
    loaderMap.put(classOf[Double], new ConfigHelper.FieldLoader[Double] {
      def load(field: Field, section: String, anno: Configurable, obj: AnyRef, config: Configuration) {
    ...
    loaderMap.put(classOf[Array[Double]], new ConfigHelper.FieldLoader[Array[Double]] {
      def load(field: Field, section: String, anno: Configurable, obj: AnyRef, config: Configuration) {
    ...
    loaderMap.put(classOf[Float], new ConfigHelper.FieldLoader[Float] {
      def load(field: Field, section: String, anno: Configurable, obj: AnyRef, config: Configuration) {
    ...
    loaderMap.put(classOf[ItemStack], new ConfigHelper.FieldLoader[ItemStack] {
      def load(field: Field, section: String, anno: Configurable, obj: AnyRef, config: Configuration) {
    ...
    loaderMap.put(classOf[Array[ItemStack]], new ConfigHelper.FieldLoader[Array[ItemStack]] {
      def load(field: Field, section: String, anno: Configurable, obj: AnyRef, config: Configuration) {
