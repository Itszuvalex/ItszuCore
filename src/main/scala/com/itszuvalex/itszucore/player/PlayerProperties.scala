 ...
 *  *****************************************************************************
 */
package com.itszuvalex.itszucore.player

import java.util

import com.itszuvalex.itszucore.ItszuCore
import com.itszuvalex.itszucore.api.player.IPlayerProperty
import com.itszuvalex.itszucore.network.PacketHandler
import com.itszuvalex.itszucore.network.messages.MessagePlayerProperty
  ...
  for (entry <- PlayerProperties.propertiesClasses.entrySet) {
    try {
      ...
      case e: InstantiationException =>
        ItszuCore.logger.log(Level.ERROR, "Failed to create new instance of " + entry.getKey + " on creating PlayerProperties for player: " + player + " name: " + player.getCommandSenderName)
        e.printStackTrace()
